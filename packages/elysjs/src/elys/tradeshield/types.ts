//@ts-nocheck
import { SpotOrderType, OrderPrice, OrderPriceAmino, OrderPriceSDKType, PerpetualPosition, TriggerPrice, TriggerPriceAmino, TriggerPriceSDKType } from "./order";
...
export interface LegacyPerpetualOrder {
  orderId: bigint;
  ownerAddress: string;
...
export interface LegacyPerpetualOrderProtoMsg {
  typeUrl: "/elys.tradeshield.LegacyPerpetualOrder";
  value: Uint8Array;
}
export interface LegacyPerpetualOrderAmino {
  order_id?: string;
  owner_address?: string;
  perpetual_order_type?: PerpetualOrderType;
  position?: PerpetualPosition;
  trigger_price?: OrderPriceAmino;
...
export interface LegacyPerpetualOrderAminoMsg {
  type: "/elys.tradeshield.LegacyPerpetualOrder";
  value: LegacyPerpetualOrderAmino;
}
export interface LegacyPerpetualOrderSDKType {
  order_id: bigint;
  owner_address: string;
  perpetual_order_type: PerpetualOrderType;
  position: PerpetualPosition;
  trigger_price?: OrderPriceSDKType;
...
export interface PerpetualOrderAmino {
  ...
  perpetual_order_type?: PerpetualOrderType;
  position?: PerpetualPosition;
  trigger_price?: TriggerPriceAmino;
  collateral?: CoinAmino;
  trading_asset?: string;
  leverage?: string;
  take_profit_price?: string;
...
export interface PerpetualOrderSDKType {
  ...
  perpetual_order_type: PerpetualOrderType;
  position: PerpetualPosition;
  trigger_price: TriggerPriceSDKType;
  collateral: CoinSDKType;
  trading_asset: string;
  leverage: string;
  take_profit_price: string;
...
function createBaseSpotOrder(): SpotOrder {
  return {
    orderType: 0,
    orderId: BigInt(0),
    orderPrice: OrderPrice.fromPartial({}),
...
export const SpotOrder = {
  ...
  encode(message: SpotOrder, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.orderPrice !== undefined) {
      OrderPrice.encode(message.orderPrice, writer.uint32(26).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.orderPrice = OrderPrice.decode(reader, reader.uint32());
          break;
        case 4:
  ...
  fromPartial(object: Partial<SpotOrder>): SpotOrder {
    ...
    message.orderPrice = object.orderPrice !== undefined && object.orderPrice !== null ? OrderPrice.fromPartial(object.orderPrice) : undefined;
  ...
  fromAmino(object: SpotOrderAmino): SpotOrder {
    ...
    if (object.order_price !== undefined && object.order_price !== null) {
      message.orderPrice = OrderPrice.fromAmino(object.order_price);
    }
  ...
  toAmino(message: SpotOrder): SpotOrderAmino {
    ...
    obj.order_price = message.orderPrice ? OrderPrice.toAmino(message.orderPrice) : undefined;
...
function createBaseLegacyPerpetualOrder(): LegacyPerpetualOrder {
  return {
    orderId: BigInt(0),
    ownerAddress: "",
...
export const LegacyPerpetualOrder = {
  typeUrl: "/elys.tradeshield.LegacyPerpetualOrder",
  encode(message: LegacyPerpetualOrder, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.orderId !== BigInt(0)) {
    ...
    if (message.triggerPrice !== undefined) {
      OrderPrice.encode(message.triggerPrice, writer.uint32(42).fork()).ldelim();
    }
    ...
    if (message.positionSize !== undefined) {
      Coin.encode(message.positionSize, writer.uint32(106).fork()).ldelim();
    }
    if (message.liquidationPrice !== "") {
      writer.uint32(114).string(Decimal.fromUserInput(message.liquidationPrice, 18).atomics);
    }
    if (message.fundingRate !== "") {
      writer.uint32(122).string(Decimal.fromUserInput(message.fundingRate, 18).atomics);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LegacyPerpetualOrder {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseLegacyPerpetualOrder();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 4:
          ...
          break;
        case 5:
          message.triggerPrice = OrderPrice.decode(reader, reader.uint32());
          break;
        case 6:
  ...
  fromPartial(object: Partial<LegacyPerpetualOrder>): LegacyPerpetualOrder {
    const message = createBaseLegacyPerpetualOrder();
    message.orderId = object.orderId !== undefined && object.orderId !== null ? BigInt(object.orderId.toString()) : BigInt(0);
    message.ownerAddress = object.ownerAddress ?? "";
    message.perpetualOrderType = object.perpetualOrderType ?? 0;
    message.position = object.position ?? 0;
    message.triggerPrice = object.triggerPrice !== undefined && object.triggerPrice !== null ? OrderPrice.fromPartial(object.triggerPrice) : undefined;
  ...
  fromAmino(object: LegacyPerpetualOrderAmino): LegacyPerpetualOrder {
    const message = createBaseLegacyPerpetualOrder();
    if (object.order_id !== undefined && object.order_id !== null) {
      message.orderId = BigInt(object.order_id);
    }
    ...
    if (object.trigger_price !== undefined && object.trigger_price !== null) {
      message.triggerPrice = OrderPrice.fromAmino(object.trigger_price);
    }
  ...
  toAmino(message: LegacyPerpetualOrder): LegacyPerpetualOrderAmino {
    const obj: any = {};
    obj.order_id = message.orderId !== BigInt(0) ? message.orderId?.toString() : undefined;
    obj.owner_address = message.ownerAddress === "" ? undefined : message.ownerAddress;
    ...
    obj.trigger_price = message.triggerPrice ? OrderPrice.toAmino(message.triggerPrice) : undefined;
  ...
  fromAminoMsg(object: LegacyPerpetualOrderAminoMsg): LegacyPerpetualOrder {
    return LegacyPerpetualOrder.fromAmino(object.value);
  },
  fromProtoMsg(message: LegacyPerpetualOrderProtoMsg): LegacyPerpetualOrder {
    return LegacyPerpetualOrder.decode(message.value);
  },
  toProto(message: LegacyPerpetualOrder): Uint8Array {
    return LegacyPerpetualOrder.encode(message).finish();
  },
  toProtoMsg(message: LegacyPerpetualOrder): LegacyPerpetualOrderProtoMsg {
    return {
      typeUrl: "/elys.tradeshield.LegacyPerpetualOrder",
      value: LegacyPerpetualOrder.encode(message).finish()
    };
  }
};
function createBasePerpetualOrder(): PerpetualOrder {
  return {
    ...
    perpetualOrderType: 0,
    position: 0,
    triggerPrice: TriggerPrice.fromPartial({}),
    collateral: Coin.fromPartial({}),
    tradingAsset: "",
    leverage: "",
    takeProfitPrice: "",
...
export const PerpetualOrder = {
  ...
  encode(message: PerpetualOrder, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.triggerPrice !== undefined) {
      TriggerPrice.encode(message.triggerPrice, writer.uint32(42).fork()).ldelim();
    }
    if (message.collateral !== undefined) {
      Coin.encode(message.collateral, writer.uint32(50).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.triggerPrice = TriggerPrice.decode(reader, reader.uint32());
          break;
        case 6:
          message.collateral = Coin.decode(reader, reader.uint32());
          break;
  ...
  fromPartial(object: Partial<PerpetualOrder>): PerpetualOrder {
    ...
    message.perpetualOrderType = object.perpetualOrderType ?? 0;
    message.position = object.position ?? 0;
    message.triggerPrice = object.triggerPrice !== undefined && object.triggerPrice !== null ? TriggerPrice.fromPartial(object.triggerPrice) : undefined;
    message.collateral = object.collateral !== undefined && object.collateral !== null ? Coin.fromPartial(object.collateral) : undefined;
    message.tradingAsset = object.tradingAsset ?? "";
    message.leverage = object.leverage ?? "";
    message.takeProfitPrice = object.takeProfitPrice ?? "";
  ...
  fromAmino(object: PerpetualOrderAmino): PerpetualOrder {
    ...
    if (object.trigger_price !== undefined && object.trigger_price !== null) {
      message.triggerPrice = TriggerPrice.fromAmino(object.trigger_price);
    }
    if (object.collateral !== undefined && object.collateral !== null) {
      message.collateral = Coin.fromAmino(object.collateral);
    }
  ...
  toAmino(message: PerpetualOrder): PerpetualOrderAmino {
    ...
    obj.perpetual_order_type = message.perpetualOrderType === 0 ? undefined : message.perpetualOrderType;
    obj.position = message.position === 0 ? undefined : message.position;
    obj.trigger_price = message.triggerPrice ? TriggerPrice.toAmino(message.triggerPrice) : undefined;
    obj.collateral = message.collateral ? Coin.toAmino(message.collateral) : undefined;
    obj.trading_asset = message.tradingAsset === "" ? undefined : message.tradingAsset;
    obj.leverage = message.leverage === "" ? undefined : message.leverage;
    obj.take_profit_price = message.takeProfitPrice === "" ? undefined : message.takeProfitPrice;
