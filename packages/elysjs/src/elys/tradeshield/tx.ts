//@ts-nocheck
import { SpotOrderType, OrderPrice, OrderPriceAmino, OrderPriceSDKType, TriggerPrice, TriggerPriceAmino, TriggerPriceSDKType, PerpetualPosition } from "./order";
...
export const MsgCreateSpotOrder = {
  ...
  encode(message: MsgCreateSpotOrder, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.orderPrice !== undefined) {
      OrderPrice.encode(message.orderPrice, writer.uint32(18).fork()).ldelim();
    }
...
export const MsgCreatePerpetualOpenOrder = {
  ...
  encode(message: MsgCreatePerpetualOpenOrder, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.triggerPrice !== undefined) {
      TriggerPrice.encode(message.triggerPrice, writer.uint32(18).fork()).ldelim();
    }
...
export const MsgUpdatePerpetualOrder = {
  ...
  encode(message: MsgUpdatePerpetualOrder, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.triggerPrice !== undefined) {
      TriggerPrice.encode(message.triggerPrice, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
