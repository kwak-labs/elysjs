...
export interface LegacyParams {
  ...
  enableBaseCurrencyPairedPoolOnly: boolean;
}
...
export interface LegacyParamsAmino {
  ...
  enable_base_currency_paired_pool_only?: boolean;
}
...
export const LegacyParams = {
  ...
  encode(message: LegacyParams, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.enableBaseCurrencyPairedPoolOnly === true) {
      writer.uint32(24).bool(message.enableBaseCurrencyPairedPoolOnly);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.enableBaseCurrencyPairedPoolOnly = reader.bool();
          break;
        default:
  ...
  fromPartial(object: Partial<LegacyParams>): LegacyParams {
    ...
    message.enableBaseCurrencyPairedPoolOnly = object.enableBaseCurrencyPairedPoolOnly ?? false;
    return message;
  },
  fromAmino(object: LegacyParamsAmino): LegacyParams {
    ...
    if (object.enable_base_currency_paired_pool_only !== undefined && object.enable_base_currency_paired_pool_only !== null) {
      message.enableBaseCurrencyPairedPoolOnly = object.enable_base_currency_paired_pool_only;
    }
    return message;
  },
  toAmino(message: LegacyParams): LegacyParamsAmino {
    ...
    obj.enable_base_currency_paired_pool_only = message.enableBaseCurrencyPairedPoolOnly === false ? undefined : message.enableBaseCurrencyPairedPoolOnly;
    return obj;
  },
