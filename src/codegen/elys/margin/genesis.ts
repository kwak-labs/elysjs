...
export interface GenesisStateProtoMsg {
  typeUrl: "/elys.margin.GenesisState";
  value: Uint8Array;
}
/** GenesisState defines the margin module's genesis state. */
...
export const GenesisState = {
  ...
  fromAmino(object: GenesisStateAmino): GenesisState {
    return {
      ...
      mtpList: Array.isArray(object?.mtp_list) ? object.mtp_list.map((e: any) => MTP.fromAmino(e)) : [],
      addressWhitelist: Array.isArray(object?.address_whitelist) ? object.address_whitelist.map((e: any) => e) : []
    };
  },
