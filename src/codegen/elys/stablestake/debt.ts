...
export const Debt = {
  ...
  fromAmino(object: DebtAmino): Debt {
    return {
      ...
      interestStacked: object.interest_stacked,
      borrowTime: BigInt(object.borrow_time),
      lastInterestCalcTime: BigInt(object.last_interest_calc_time)
    };
  },
  toAmino(message: Debt): DebtAmino {
    ...
    obj.interest_stacked = message.interestStacked;
    obj.borrow_time = message.borrowTime ? message.borrowTime.toString() : undefined;
    obj.last_interest_calc_time = message.lastInterestCalcTime ? message.lastInterestCalcTime.toString() : undefined;
    return obj;
  },
